...
void read_input_parameters1(int, char **, char *, char *, char *, long *, 
			   long *);
...
int main3 (int argc, char* argv[])
{
  ...
  read_input_parameters1(argc,argv,docfile,modelfile,predictionsfile,
...
void read_input_parameters1(int argc, char **argv, char *docfile, 
