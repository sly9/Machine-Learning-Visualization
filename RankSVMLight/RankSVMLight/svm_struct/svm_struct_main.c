...
void   read_input_parameters4(int, char **, char *, char *,long *, long *,
...
{  
  ...
  read_input_parameters4(argc,argv,trainfile,modelfile,&verbosity,
...
void read_input_parameters4(int argc,char *argv[],char *trainfile,
			   char *modelfile,
