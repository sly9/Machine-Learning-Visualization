...
void read_input_parameters3(int, char **, char *, char *, char *, 
...
int main5 (int argc, char* argv[])
{
  ...
  read_input_parameters3(argc,argv,testfile,modelfile,predictionsfile,&sparm,
...
void read_input_parameters3(int argc,char *argv[],char *testfile,
			   ...
			   long *verbosity,long *struct_verbosity)
{
  ...
  for(i=1;(i<argc) && ((argv[i])[0] == '-');i++) {
    switch ((argv[i])[1]) 
      { 
      case 'h': print_help3(); exit(0);
      case '?': print_help3(); exit(0);
