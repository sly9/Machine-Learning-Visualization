...
void   read_input_parameters0(int, char **, char *, char *, char *, long *, 
...
{  
  ...
  read_input_parameters0(argc,argv,docfile,modelfile,restartfile,&verbosity,
			&learn_parm,&kernel_parm);
...
void read_input_parameters0(int argc,char *argv[],char *docfile,char *modelfile,
